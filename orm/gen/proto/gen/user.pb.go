...
type User struct {
	...
	Id   int64  `orm:"column=id" protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"` //@orm column=id
	Name string `orm:"" protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`
}
